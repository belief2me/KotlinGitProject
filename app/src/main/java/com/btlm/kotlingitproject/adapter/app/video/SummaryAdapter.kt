...
import com.btlm.kotlingitproject.widget.flowlayout.TagFlowLayout
        ...
        when (mulSummary.itemType) {
            ...
            MulSummary.TYPE_OWNER -> {
                mulSummary.owner?.let {
                    ...
                    holder.getView<View>(R.id.iv_avatar).setOnClickListener {
//                        mContext.startActivity(Intent(mContext, UpDetailActivity::class.java))
                    }
