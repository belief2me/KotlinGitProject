package com.btlm.kotlingitproject.adapter.discover.section
...
import com.btlm.kotlingitproject.module.discover.AllGameActivity
    ...
    override fun onBindFooterViewHolder(holder: ViewHolder) {
        if (mFlag) {
            ...
            holder.itemView.setOnClickListener {
                mContext.startActivity(Intent(mContext, AllGameActivity::class.java))
            }
        } else {
            gone(holder.itemView)
        }
